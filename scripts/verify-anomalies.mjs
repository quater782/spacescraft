...
assert.match(rendererSource, /syncAnomalyState\(world\)/);
...
console.log("Living Sector Anomaly Engine verified: nine seeded one-per-sector fields, chapter-one safety, counter-steerable forces, asymmetric projectile coupling, economy/combat/music integration, bilingual HUD/results, and retained field diagnostics.");
