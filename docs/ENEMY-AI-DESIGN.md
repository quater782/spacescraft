...
下方 2026-09-19 小节是当前规则，其后 2026-09-12/13 内容是原始设计依据，历史现状与候选参数不作为当前实现事实。2026-09-13 已新增 `src/enemy-ai.js`，在保留护盾、激光和星链已有修改的基础上接入全部敌军。没有调整版本、存档或安装包；验证结果与边界见[项目状态](./PROJECT-STATE.md)。

## 2026-09-19 当前规则：可辨识的智能精英
