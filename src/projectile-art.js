...
const STAMPS = Object.freeze({
  ...
  bolt2: ["..h..", "..b..", ".bhb.", "dbbbd", ".b.b.", "..d.."],
  bolt3: ["...h...", "..bhb..", ".bbhbb.", "dbbhbbd", ".bbdbb.", "..b.b..", "..d.d.."],
  heavy2: ["..hhh..", ".bbhbb.", "bbbhbbb", "dbbdbbd", ".bbbbb.", "..d.d.."],
  heavy3: ["...h...", ".bhhhb.", "bbbhbbb", "dbhhhbd", "bbbhbbb", ".bdddb.", "..h.h..", "..d.d.."],
  fan1: ["...b.", "..hb.", ".bhb.", "bbbd.", "d.d.."],
  fan2: ["...h..", "..bhb.", ".bhhbd", "bbhbd.", ".bdd..", "..d..."],
  fan3: ["...h...", ".b.h.b.", "bbhhhbb", ".bhhhb.", "..bhb..", ".bd.db.", "..d.d.."],
  drone2: ["...h...", "..bhb..", ".bbbbb.", "hbdbdbh", "d..b..d", "...d..."],
  drone3: ["...h...", "..bhb..", "hbbhbbh", "dbhhhbd", ".bdbdb.", "h..b..h", "d..d..d"],
  overload1: [".b...b.", ".h.b.h.", "bbhhhbb", ".h.b.h.", ".b.d.b.", "...d..."],
  overload2: ["..h...h..", ".bh.b.hb.", "dbh.h.hbd", ".bhhhhb..", "dbh.h.hbd", ".bh.b.hb.", "..d.d.d.."],
