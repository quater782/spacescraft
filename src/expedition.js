(() => {
  ...
  const BIOMES = freezeAll([
    { id: "sugarBloom", stageIndex: 0, nameKey: "biome.sugarBloom.name", descriptionKey: "biome.sugarBloom.description", accent: "#ff78aa", secondary: "#ffcf6e", enemyHp: .96, spawnRate: .96, bulletSpeed: .96, bpmOffset: -4, musicShift: 0, typeBias: "scout", preferredMove: "weave", speciesId: "nectarMoth", preferredWeapon: "seeker", preferredAi: "pack" },
    { id: "crystalOrchard", stageIndex: 0, nameKey: "biome.crystalOrchard.name", descriptionKey: "biome.crystalOrchard.description", accent: "#bd8cff", secondary: "#7fffe2", enemyHp: 1.02, spawnRate: .94, bulletSpeed: 1, bpmOffset: 2, musicShift: 2, typeBias: "spinner", preferredMove: "drift", speciesId: "prismRay", preferredWeapon: "laser", preferredAi: "oracle" },
    { id: "cometTide", stageIndex: 0, nameKey: "biome.cometTide.name", descriptionKey: "biome.cometTide.description", accent: "#68d9ff", secondary: "#ff9acb", enemyHp: .98, spawnRate: 1, bulletSpeed: 1.04, bpmOffset: 5, musicShift: -2, typeBias: "dart", preferredMove: "rush", speciesId: "cometRammer", preferredWeapon: "pulse", preferredAi: "ambusher" },
    { id: "auroraFoundry", stageIndex: 1, nameKey: "biome.auroraFoundry.name", descriptionKey: "biome.auroraFoundry.description", accent: "#68f4df", secondary: "#ffe16c", enemyHp: 1.04, spawnRate: .98, bulletSpeed: 1.04, bpmOffset: -3, musicShift: 0, typeBias: "spinner", preferredMove: "weave", speciesId: "auroraLeech", preferredWeapon: "laser", preferredAi: "hunter" },
    { id: "thunderWorks", stageIndex: 1, nameKey: "biome.thunderWorks.name", descriptionKey: "biome.thunderWorks.description", accent: "#f9d65c", secondary: "#79d9ff", enemyHp: 1.08, spawnRate: 1.02, bulletSpeed: 1.08, bpmOffset: 6, musicShift: -1, typeBias: "tank", preferredMove: "rush", speciesId: "railBeetle", preferredWeapon: "bomb", preferredAi: "pack" },
    { id: "cloudReef", stageIndex: 1, nameKey: "biome.cloudReef.name", descriptionKey: "biome.cloudReef.description", accent: "#72d5e8", secondary: "#ffb36a", enemyHp: 1.1, spawnRate: .94, bulletSpeed: 1, bpmOffset: -6, musicShift: 2, typeBias: "mine", preferredMove: "drift", speciesId: "reefMedusa", preferredWeapon: "bomb", preferredAi: "flanker" },
    { id: "eclipseCarnival", stageIndex: 2, nameKey: "biome.eclipseCarnival.name", descriptionKey: "biome.eclipseCarnival.description", accent: "#ff5d78", secondary: "#c183ff", enemyHp: 1.1, spawnRate: 1.02, bulletSpeed: 1.1, bpmOffset: 2, musicShift: 0, typeBias: "dart", preferredMove: "rush", speciesId: "eclipseReaper", preferredWeapon: "seeker", preferredAi: "ambusher" },
    { id: "prismGrave", stageIndex: 2, nameKey: "biome.prismGrave.name", descriptionKey: "biome.prismGrave.description", accent: "#b57dff", secondary: "#71f5e2", enemyHp: 1.14, spawnRate: .98, bulletSpeed: 1.12, bpmOffset: 7, musicShift: 3, typeBias: "spinner", preferredMove: "weave", speciesId: "graveMirror", preferredWeapon: "laser", preferredAi: "oracle" },
    { id: "voidGarden", stageIndex: 2, nameKey: "biome.voidGarden.name", descriptionKey: "biome.voidGarden.description", accent: "#63e6a8", secondary: "#ff6c94", enemyHp: 1.08, spawnRate: 1.06, bulletSpeed: 1.04, bpmOffset: -2, musicShift: -3, typeBias: "mine", preferredMove: "drift", speciesId: "gardenSpore", preferredWeapon: "bomb", preferredAi: "pack" },
  ]);
